...
<div class="col-lg-12 col-xxl-4">
    ...
    <div class="card card-custom bg-gray-100 card-stretch gutter-b">
        <!--begin::Header-->
        <div class="card-header border-0 bg-danger py-5" style=" background:rgb(173, 171, 171) !important;">
            {{-- <h3 class="card-title font-weight-bolder text-white">Info </h3> --}}
        ...
        <div class="card-body p-0 position-relative overflow-hidden">
            <!--begin::Chart-->
            <div  class="card-rounded-bottom bg-danger" style="height: 200px; min-height: 200px; background:rgb(173, 171, 171) !important;"></div>
            <!--end::Chart-->
            <!--begin::Stats-->
            <div class="card-spacer mt-n25">
                ...
                <div class="row m-0">
                    <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
                        ...
                        <a href="{{ route('categories') }}" class="text-warning font-weight-bold font-size-h6">"{{ $categories->count() }}"{{ __('message.categories') }}</a>
                    </div>
                    <div class="col bg-light-primary px-6 py-8 rounded-xl mb-7">
                        ...
                        <a href="{{ url('user/profile') }}" class="text-primary font-weight-bold font-size-h6 mt-2">" {{ __('message.admins') }}"{{$users->count()}}</a>
                    </div>
                </div>
                <!--end::Row-->
                <!--begin::Row-->
                <div class="row m-0">
                    <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7">
                        ...
                        <a href="{{ route('stores') }}" class="text-danger font-weight-bold font-size-h6 mt-2">"{{ $stores->count() }} "{{ __('message.stores') }}</a>
                    </div>
                    <div class="col bg-light-success px-6 py-8 rounded-xl">
                        <span class="svg-icon svg-icon-3x svg-icon-success d-block my-2">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Urgent-mail.svg-->
                        ...
                        <a href="{{ route('product') }}" class="text-success font-weight-bold font-size-h6 mt-2">"{{ $products->count() }}" {{ __('message.products') }}</a>
                    </div>
                </div>
                <!--end::Row-->
            </div>
